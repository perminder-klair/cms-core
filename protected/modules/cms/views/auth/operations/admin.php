                  ...
                  <div class="span12">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?=$value;?></td>
                          <td><?=l('Edit',array('/cms/auth/updateOperation', 'name'=>$key), array('class'=>'btn btn-mini btn-primary'));?></td>
                          <td><?=l('Delete','', array('class'=>'btn btn-mini delete_dialog', 'data-url'=>url("/cms/auth/deleteOperation",array('name'=>$key))));?></td>
                        </tr>
                        <? endforeach; ?>
                      </tbody>
                    </table>
